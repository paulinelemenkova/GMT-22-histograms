...
ps=Hist_two_KKT_south14j.ps
# Step-3. Plot rose diagram
gmt psrose table1.txt -i1,4 -R0/1/0/360 \
    -A7r -S1.0in \
    -Gthistle -Bx0.2g0.2 \
    -By30g30+l"Cross-section profiles of the trench, southern part" \
...
gmt pshistogram table1.txt -i4 -R-9000/6/0/20 -JX4.8i/2.4i -X3.6i \
    ...
    -BWSne+t"Histograms of the depths frequency distribution: southern part"+gsnow1 -Glightsteelblue1 \
...
gmt psconvert Hist_two_KKT_south14j.ps -A0.2c -E720 -P -Tj -Z
