...
gmt pshistogram tableHis.txt -i4 -R-3200/6/0/15 -JX4.8i/2.4i -Y7.5c\
    ...
    -BWSne+gsnow1 -Glightsteelblue1 \
    -D+f7p,Times-Roman,black -L0.1p,dimgray -Z1 -W100 -N0+pred -N1+pblue -N2+pgreen \
    -O -K >> $ps
...
gmt pshistogram tableP.txt -i4 -R-7000/6/0/20 -JX4.8i/2.4i -Y7.5c\
    -Bpxg1000a1000f100+l"Bathymetry (m)" \
    -Bpyg5a5f2.5+l"Frequency"+u" %" -Bsyg2.5 \
    -BWSne+t"Histograms on bathymetry: Puysegur (A), Hikurangi (B) and Hjort (C) trenches"+gsnow1 -Glightsteelblue1 \
    -D+f7p,Times-Roman,black -L0.1p,dimgray -Z1 -W250 -N0+pred -N1+pblue -N2+pgreen \
    -O -K >> $ps
