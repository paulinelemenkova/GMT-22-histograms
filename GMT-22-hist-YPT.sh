...
gmt pshistogram tablePT.txt -i4 -R-8000/6/0/25 -JX4.8i/2.4i -X3.6i \
...
# YAP
# Plot histogram
gmt pshistogram tableYT.txt -i4 -R-8000/6/0/25 -JX4.8i/2.4i -Y7.5c\
    -Bpxg1000a1000f100+l"Bathymetry (m)" \
    -Bpyg5a5f2.5+l"Frequency"+u" %" -Bsyg2.5 \
-BWSne+t"Histograms on bathymetric data: Yap (A) and Palau (B) trenches "+gsnow1 -Glightsteelblue1 \
    -D+f7p,Times-Roman,black -L0.1p,dimgray -Z1 -W250 -N0+pred -N1+pblue -N2+pgreen \
    -O -K >> $ps
...
gmt psconvert Hist_YPT.ps -A0.5c -E720 -P -Tj -Z
