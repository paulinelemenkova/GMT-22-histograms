#!/bin/bash
# Purpose: Plot two histograms of the cross-section profiles (here: Aleutian Trench)
...
gmt psrose tableA2.txt -i1,4 -R0/1/0/360 \
    -A7r -S1.0in \
    -Glightsteelblue1 -Bx0.2g0.2 \
    -By30g30+l"Bathymetric data distribution by cross-section profiles" \
    -B+t"Aleutian Trench: Rose diagram on the cross-section profiles"+gghostwhite \
    -M0.5c+e+gred2+n1c \
    -W0.1p,red -Cm \
    -UBL/-15p/-65p -Vv -K > $ps
# Step-4. Plot histogram
gmt pshistogram table2.txt -i4 -R-8200/1000/0/20 -JX4.8i/2.4i -X3.6i \
    -Bpxg1000a1000f100+l"Bathymetry (m)" \
    -Bpyg5a5f2.5+l"Frequency distribution"+u" %" -Bsyg2.5 \
    -BWSne+t"Aleutian Trench: Histograms of the depths values on the cross-section profiles"+gghostwhite -Gpowderblue \
...
gmt psconvert Hist_AT.ps -A0.2c -E720 -P -Tj -Z
