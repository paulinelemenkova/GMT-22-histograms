...
gmt pshistogram tableH.txt -i4 -R-7000/6/0/33 -JX4.8i/2.4i -X3.6i \
    ...
    -UBL/8.5c/-1.8c -K > $ps
echo "-6600 28 B" | gmt pstext -R -J -F+jBR+f15p,black -Gfloralwhite -W0.5p -O -K >> $ps
# Step-5. Add legend
...
EOF
#
# Puysegur trench (NORTH)
# Plot histogram
gmt pshistogram tableP.txt -i4 -R-7000/6/0/20 -JX4.8i/2.4i -Y7.5c\
    -Bpxg1000a1000f100+l"Bathymetry (m)" \
    -Bpyg5a5f2.5+l"Frequency"+u" %" -Bsyg2.5 \
-BWSne+t"Histograms on bathymetric data: Puysegur Trench (A) and Hjort Trench (B)"+gsnow1 -Glightsteelblue1 \
    -D+f7p,Times-Roman,black -L0.1p,dimgray -Z1 -W250 -N0+pred -N1+pblue -N2+pgreen \
    -O -K >> $ps
...
gmt psconvert Hist_HPT.ps -A0.5c -E720 -P -Tj -Z
