...
gmt pshistogram tableCT.txt -i4 -R-3000/1500/0/13.5 -JX4.8i/2.4i -X3.6i \
    ...
    -D+f6p,Times-Roman+o2p -L0.1p,dimgray -Z1 -W100 -N1+pblue -N2+pgreen -K > $ps

# Step-4. Add legend
gmt pslegend -R -J -Dx1.0/-2.3+w8.0c+o-1.0/0.5c \
    -F+pthick+ithinner+gwhite \
    --FONT_ANNOT_PRIMARY=8p,Helvetica,black -O -K << EOF >> $ps
N 2
...
# Step-5. Add GMT logo
gmt logo -Dx10.0/0.0+o-0.5c/-1.8c+w2c -O >> $ps
